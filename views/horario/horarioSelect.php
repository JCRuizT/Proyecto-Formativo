...
?>
						...
						<tr>
							...
							<td><a href="views/assets/horarios/<?php echo $filas->Hor_Ruta; ?>"  download="<?php echo $filas->Hor_Ruta;?>"> <button class="btn btn-warning">Descargar</button></a></td>
							<td><a href="views/assets/horarios/horarioView.php?ruta=<?php echo $filas->Hor_Ruta; ?>"  target="_blank"> <button class="btn btn-success">Visualizar PDF</button></a></td></td>
						</tr>
				<?php endforeach;?>
		</tbody>
</table>
