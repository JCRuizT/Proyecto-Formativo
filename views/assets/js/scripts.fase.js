...
function Insertar() {
    ...
    var nombre = document.formfase.nombre.value;
    ...
    ajax.send("ctrl=fase&acti=insertar&nombre="+nombre);
}
...
function Borrar(id) {
    ...
    ajax.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
    ajax.send("ctrl=fase&acti=eliminar&id=" + id);
}



function Editar(id, nombre) {
    document.formfase.id.value = id;
    document.formfase.nombre.value = nombre;
...
function Update() {
    ...
    var result = document.getElementById('tview');
    var id = document.formfase.id.value;
    var nombre = document.formfase.nombre.value;
    ...
    ajax.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
    ajax.send("ctrl=fase&acti=actualizar&id="+id+"&nombre="+nombre);
}
