...
function Insertar() {
    ...
    var nombre = document.formrol.nombre.value;
...
function Editar(id, nombre) {
    ...
    document.formrol.nombre.value = nombre;
...
function Update() {
    ...
    ajax.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
    ajax.send("ctrl=rol&acti=actualizar&id=" + id + "&nombre=" + nombre);
}
