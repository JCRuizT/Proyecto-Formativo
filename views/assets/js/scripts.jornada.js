...
function InsertJornada() {
    var result = document.getElementById('tview');

    var nombre = document.formjornada.nombre.value;
    ...
    ajax.send("ctrl=jornada&acti=insertar&nombre=" + nombre);
}
...
function BorrarJornada(id) {
    ...
    ajax.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
    ajax.send("ctrl=jornada&acti=eliminar&id=" + id);
}



function Editar(id, nombre) {
    document.formjornada.id.value = id;
    document.formjornada.nombre.value = nombre;
...
function Update() {
    ...
    var result = document.getElementById('tview');
    var id = document.formjornada.id.value;
    var nombre = document.formjornada.nombre.value;
    ...
    ajax.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
    ajax.send("ctrl=jornada&acti=actualizar&id=" + id + "&nombre=" + nombre);
}
